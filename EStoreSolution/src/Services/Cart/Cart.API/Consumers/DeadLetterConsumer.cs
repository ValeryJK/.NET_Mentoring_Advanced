...
namespace Cart.API.Consumers
{
    ...
    {
        private readonly ILogger<DeadLetterConsumer> logger;
        ...
        {
            this.logger.LogWarning("Message moved to DLQ: ItemId: {ItemId}, Name: {Name}", context.Message.Id, context.Message.Name);
