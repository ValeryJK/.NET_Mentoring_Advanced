...
namespace Cart.API.Controllers.V1
{
    ...
    public class CartsController : ControllerBase
    {
        ...
        {
            var result = await this.mediator.Send(new GetCartQuery { CartId = cartId });
        ...
        {
            var result = await this.mediator.Send(new CreateCartCommand { CartId = cartId, InitialItems = command.InitialItems });
